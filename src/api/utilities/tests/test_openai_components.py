...
class ChatGPTTestCase(APITestCase):
    ...
    def setUp(self):
        self.api_response = {
            ...
            'choices': [
                {'finish_reason': 'stop', 'index': 0, 'logprobs': None, 'message': {'content': 'Hello! How can I assist you today?', 'role': 'assistant'}}
            ],
            'created': 1717592376,
        ...
        self.api_response_headers = {
            'date': 'Wed, 05 Jun 2024 12:59:36 GMT', 'content-type': 'application/json', 'transfer-encoding': 'chunked', 'connection': 'keep-alive', 'openai-organization': 'texta-o', 'openai-processing-ms': '500', 'openai-version': '2020-10-01',
            'strict-transport-security': 'max-age=15724800; includeSubDomains', 'x-ratelimit-limit-requests': '500', 'x-ratelimit-limit-tokens': '30000', 'x-ratelimit-remaining-requests': '499', 'x-ratelimit-remaining-tokens': '29972',
            'x-ratelimit-reset-requests': '120ms', 'x-ratelimit-reset-tokens': '56ms', 'x-request-id': 'req_b74e6ad94b04367098b39f1c3acf54b2', 'cf-cache-status': 'DYNAMIC',
            ...
            'server': 'cloudflare', 'cf-ray': '88f0573e1a507125-TLL', 'content-encoding': 'gzip', 'alt-svc': 'h3=":443"; ma=86400'
        }

        self.api_status_code = 200

    def test_simple_chat_completion(self):
        with mock.patch("api.utilities.gpt.ChatGPT.commit_api", return_value=(self.api_response_headers, self.api_response, self.api_status_code)) as mck:
